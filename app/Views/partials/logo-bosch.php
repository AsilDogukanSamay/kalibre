<?php
/**
 * Bosch kurumsal amblemi. Orijinal vektor yolu korunmustur;
 * renk currentColor ile tasarim sisteminden yonetilir.
 * Kaynak: Simple Icons (CC0 ikon dosyasi). Marka Robert Bosch GmbH tescillidir.
 * @var string $size
 */
$size = $size ?? 'h-8 w-8';
?>
<span class="inline-flex items-center gap-2.5">
    <svg class="<?= e($size) ?> shrink-0 text-brand" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Bosch">
