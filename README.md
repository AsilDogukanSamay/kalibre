...
| Test | 303 test + 4 tarayıcı denetimi, hepsi geçiyor |
...
| `npm test` | 303 test. CSS'i önce kendisi derler (`pretest`), çünkü altı test derlenmiş çıktıyı okur |
...
```bash
npm test          # 303 test (php tests/run.php) - harici bagimlilik yok
...
**Mevcut durum:** 303 test geçiyor · yerleşim 0 kusur · kontrast eşik altı 0
