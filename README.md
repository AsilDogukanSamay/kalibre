...
| Test | 264 test + 4 tarayıcı denetimi, hepsi geçiyor |
...
| `npm test` | 264 test (harici bağımlılık yok) |
...
```bash
npm test          # 264 test (php tests/run.php) - harici bagimlilik yok
...
**Mevcut durum:** 264 test geçiyor · yerleşim 0 kusur · kontrast eşik altı 0
